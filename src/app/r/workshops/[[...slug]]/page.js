    ...
    return (
      <div className="min-h-screen bg-gray-900 p-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold text-white mb-6">🎤 Workshops & Talks</h1>
          <p className="text-gray-400 mb-8">Quick links to my presentation materials</p>
          <div className="space-y-3">
            {Object.entries(workshops).map(([key, value]) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm">workshops.stimmie.dev/{key}</p>
              </Link>
            ))}
          </div>
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-8">
        <div className="text-center text-white max-w-md">
          ...
          <p className="text-gray-400 mb-4">
            This link hasn&apos;t been configured yet. Please update the URL in the code.
          </p>
    ...
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center text-white">
        ...
        <p className="text-sm text-gray-400 mt-2">
          If you&apos;re not redirected, <a href={workshop.url} className="text-blue-400 hover:underline">click here</a>
        </p>
      </div>
    </div>
  );
