  ...
  return (
    ...
    >
      ...
      <article className="neo-prose">
        ...
        <p>
          There&apos;s a flight simulator inside Microsoft Excel 97.
        </p>
        ...
        <p>
          ...
          What&apos;s left is a range of purple hills under a black sky, and you
        ...
        <p>
          ...
          moved by and yet here I&apos;m. It had no purpose and it wasn&apos;t in the
        ...
        <p>
          The first easter egg came out of a grudge. In 1979 Atari didn&apos;t print the names of its programmers anywhere. A
          ...
          those terms and decided he wouldn&apos;t be erased.
        </p>
        ...
        <p>
          ...
          that wasn&apos;t supposed to be there. Inside, in flashing letters, the
        ...
        <p>
          ...
          time I was old enough to notice, though I didn&apos;t notice.
        </p>
        ...
        <p>
          ...
          can&apos;t buy a product with code in it that nobody documented. A hidden flight simulator and a hidden backdoor look the same from
        ...
        <p>
          ...
          hide, and there&apos;s nowhere to hide in a codebase where two other
          people read every line before it&apos;s merged. If someone opens a pull
          request and finds four hundred lines of terrain generation in a
          spreadsheet, they ask what it&apos;s for, and the moment there&apos;s an
        ...
        <Figure
          ...
          caption="Name a sheep jeb_ and it won&apos;t stop changing colour."
          narrow
        />
        ...
        <p>
          I&apos;ve watched an app appear in the time it takes to make coffee,
          and I&apos;ve made some of them myself. You describe what you want to a text box and
          you step away, and when you come back it&apos;s there: the routing, the
        ...
        <p>
          This is the part I find hard to say plainly, so I&apos;ll say it the
          long way. It baffles me a little, but you don&apos;t want to leave a
          piece of yourself in that app, and I think it&apos;s because no piece of
          ...
          eleven minutes isn&apos;t long enough to earn that.
        </p>
        ...
        <Figure
          ...
          caption="Over a thousand packages on npm that listen for it. You don&apos;t write the easter egg. You install it."
          narrow
        />
        ...
        <p>
          ...
          and a great deal of the hurting was, if we&apos;re being honest,
          pointless. The tools
          are better and the things get built. I use the text box too, and I
          will keep using it, and I don&apos;t think there&apos;s anything to apologise
          for in that.
        </p>
        ...
        <p>
          ...
          generated code took away the one thing it couldn&apos;t survive without,
        ...
        <p>
          I write this more solemnly than the subject deserves, and I know it. It&apos;s a
          spreadsheet with a flight simulator in it, and a sheep that changes
          colour. But I&apos;ve noticed that the things I make quickly, I don&apos;t
        ...
        <p>
          If you&apos;re still building the slow way somewhere, on something no one
          asked you for, leave the room in, a line that only shows on one day of
          the year, or a command that isn&apos;t in the help text and does
        ...
        <p>
          ...
          there&apos;s a wall with a name on it, and the name is there because a
          person was.
        </p>
