...
function ArchiveBanner() {
  return (
    <div className="fixed top-0 left-0 right-0 bg-yellow-600 text-black text-center py-2 z-[100] text-sm font-medium">
      📜 You&apos;re viewing an archived version (v2.0) of this portfolio.
...
import { blogPosts } from "@/archive/v2/blogs";
import { projects } from "@/archive/v2/projects";
import { socialCategories } from "@/archive/v2/socials";
import { talks } from "@/archive/v2/talks";
...
const services = [
  {
    ...
    description:
      "Custom web apps, APIs, and automation solutions for your business.",
  },
  {
    title: "Data Science & Analytics",
    description:
      "Turn your data into actionable insights with modern ML/AI tools.",
  },
  {
    title: "Workshops & Training",
    description:
      "Hands-on sessions on data science, Python, and tech fundamentals.",
  },
  {
    title: "Consulting",
    description: "Technical guidance for startups and organizations.",
  },
];
...
export default function HomeClient({ mediaData }) {
  ...
  return (
    <div
      className="absolute inset-0 h-screen bg-black w-full overflow-hidden"
      lang="en"
    >
      <ArchiveBanner />
      ...
      >
        ...
        <button
          ...
          aria-label={
            overlayMinimized
              ? "Expand portfolio overlay"
              : "Minimize portfolio overlay"
          }
          ...
          >
            ...
            */}
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-5 md:h-full md:auto-rows-fr">
              ...
              >
                <header>
                  <h1 className="font-sans text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black text-white">
                    Stimmie
                  </h1>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <h2 className="font-bold text-base md:text-lg text-white group-hover:text-blue-400 transition-colors">
                      📝 Blog
                    </h2>
                    <span
                ...
                <div className="grid grid-cols-1 gap-2 md:overflow-y-auto custom-scrollbar md:h-[calc(100%-2.5rem)]">
                  {services.map((s, idx) => (
                    ...
                    >
                      ...
                      <p className="text-[9px] md:text-[10px] text-white/60 line-clamp-2">
                        {s.description}
                      </p>
                    </div>
                  ))}
              ...
              >
                ...
                <div className="flex flex-col gap-3 md:h-[calc(100%-2.5rem)] md:overflow-y-auto custom-scrollbar">
                  ...
                  {film && (
                    <Link
                      href={film.link || "https://letterboxd.com/stimmieuwu"}
                      target="_blank"
                        ...
                        <div className="flex flex-col justify-center min-w-0">
                          ...
                          {film.rating && (
                            <p className="text-[10px] text-yellow-400">
                              ...
                              {"☆".repeat(5 - Math.round(film.rating))}
                            </p>
                          )}
                        </div>
                      </div>
                  ...
                  {anime && (
                    <Link
                      href={
                        anime.link ||
                        "https://myanimelist.net/profile/amorgosposter"
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group"
                  ...
                  {book && (
                    <Link
                      href={book.link || "https://goodreads.com/stimmie"}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group"
                    >
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:overflow-y-auto custom-scrollbar md:h-[calc(100%-3rem)]">
                  {[
                    {
                      name: "Kape",
                      url: "https://kape.stimmie.dev",
                      desc: "Support me / Buy me a coffee",
                      icon: "☕",
                    },
                    {
                      name: "Room TBA",
                      url: "https://room-tba.stimmie.dev",
                      desc: "UPLB 3D Campus Viewer",
                      icon: "🗺️",
                    },
                    {
                      name: "GradeSim",
                      url: "https://gradesim.stimmie.dev",
                      desc: "Course Planner & Simulator",
                      icon: "🎓",
                    },
                    {
                      name: "HearthCraft",
                      url: "https://hearthcraft.stimmie.dev",
                      desc: "Minecraft Server Museum",
                      icon: "⛏️",
                    },
                    {
                      name: "Atlas",
                    ...
                    {
                      name: "Data",
                      url: "https://data.stimmie.dev",
                      desc: "Data Science & ML",
                      icon: "📊",
                    },
                    {
                      name: "The Crib",
                      url: "https://crib.stimmie.dev",
                      desc: "Personal Sandbox",
                      icon: "🏠",
                    },
                    {
                      name: "Workshops",
                      url: "https://workshops.stimmie.dev",
                      desc: "Slide Decks & Materials",
                      icon: "🎤",
                    },
                    {
                      name: "Minecraft",
                      ...
                      desc: "Java/Bedrock Server",
                      icon: "🎮",
                    },
                    {
                      name: "Server Map",
                      url: "https://map.stimmie.dev",
                      desc: "The Crib Live Map",
                      icon: "📍",
                    },
                    {
                      name: "Web Dev",
                      url: "https://web.stimmie.dev",
                    ...
                    },
                    {
                      ...
                      desc: "Tech Repair Services",
                      icon: "🔧",
                    },
                    {
                      name: "Links",
                      url: "https://links.stimmie.dev",
                      desc: "Quick Redirects",
                      icon: "🔗",
                    },
                  ].map((site) => (
                    <Link
                      key={site.name}
                      href={site.href || site.url}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    >
                      <div className="bg-gray-800/80 rounded-xl p-3 h-full shadow-sm">
                        ...
                        <p className="text-xs font-medium text-blue-300 mt-2 truncate">
